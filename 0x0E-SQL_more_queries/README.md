...
(https://intranet.alxswe.com/rltoken/RniBKj48bnIN8xpXhGl1yALTER TABLE first_table MODIFY `name` VARCHAR(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;)
